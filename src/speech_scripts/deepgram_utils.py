...
class DeepgramUtils:
    ...
    def __init__(self):
        ...
        self.api_key = os.getenv("DEEPGRAM_API_KEY_WNI")
        if not self.api_key:
            rospy.logerr("DEEPGRAM_API_KEY environment variable not set!")
            rospy.logerr("Please set it with: export DEEPGRAM_API_KEY=your_api_key_here")
